...
Thanks for your interest. This file is intentionally short — operational details and the full rule set live in [`AGENTS.md`](./AGENTS.md).

## Before you start

1. Read [`AGENTS.md`](./AGENTS.md) end-to-end. It defines coding standards, test rules, coverage gates, commit and PR conventions.
2. Find or create the ADR you are implementing under [`docs/adr/`](./docs/adr/). Every code-producing PR links to one.
...
6. Open the PR. The template prompts you for the ADR link, risk, rollback, and observability impact. Fill it in.
